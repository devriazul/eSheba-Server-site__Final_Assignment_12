...
const run = async () => {
  try {
    ...
    const productsCollection = client.db("eShebaDB").collection("products");
    const orderCollection = client.db("eShebaDB").collection("orders");
...
// Create Root API
app.get("/", (req, res) => {
  res.send("Running eSheba Server");
});
